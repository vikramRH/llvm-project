...
; RUN: opt -mtriple=amdgcn-- -S -passes=structurize-cfg,si-annotate-control-flow %s | FileCheck -check-prefix=OPT %s
; RUN: llc -mtriple=amdgcn -verify-each < %s | FileCheck -check-prefix=GCN %s
