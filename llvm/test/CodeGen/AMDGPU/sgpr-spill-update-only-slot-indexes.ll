...
; RUN: llc -mtriple=amdgcn -mcpu=gfx900 --regalloc-npm='regallocfast<filter=sgpr;no-clear-vregs>,default,regallocfast<filter=vgpr;no-clear-vregs>' < %s | FileCheck -check-prefix=GCN %s
