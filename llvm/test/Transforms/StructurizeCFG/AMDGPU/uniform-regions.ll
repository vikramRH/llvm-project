...
; RUN: opt -mtriple=amdgcn-- -S -o - -passes='structurize-cfg<skip-uniform-regions>' -structurizecfg-relaxed-uniform-regions < %s | FileCheck %s
; RUN: opt -mtriple=amdgcn-- -S -o - -passes=structurize-cfg -structurizecfg-skip-uniform-regions -structurizecfg-relaxed-uniform-regions < %s | FileCheck %s
